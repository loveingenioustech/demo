...
/**
 * Executes all SQL statements in a file. Call this program as java -classpath
 * driverPath:. ExecSQL commandFile
 */
class ExecSQLDemo
{
    ...
    public static Connection getConnection() throws SQLException, IOException
    {
        ...
        InputStream in = ExecSQLDemo.class.getResourceAsStream("database.properties");
