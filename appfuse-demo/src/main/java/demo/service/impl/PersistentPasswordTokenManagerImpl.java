...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see demo.service.impl.PasswordTokenManager#generateRecoveryToken(demo.model.User)
     */
    @Override
    ...
    /**
     * @see demo.service.impl.PasswordTokenManager#isRecoveryTokenValid(demo.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see demo.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
