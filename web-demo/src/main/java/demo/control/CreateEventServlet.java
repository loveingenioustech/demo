...
public class CreateEventServlet extends HttpServlet
{
            ...
            IOException
    {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("ListEventServlet");
